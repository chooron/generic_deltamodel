...
load_path = r"E:\PaperCode\generic_deltamodel\project\output\blendv3.3\camels_531\train1999-2008\no_multi\LstmMlpModel_E5_R365_B100_H128_128_n1_noLn_noWU_111111\blendv3\NseBatchLoss\36dyn\test1989-1999_Ep100"

w1_arr = np.load(join(load_path, 'all_baseflow1.npy')).squeeze()
